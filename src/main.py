...
def main():
    ...
    all_cooked_time, all_cooked_bw, all_file_names,all_cooked_rtt = load_trace.load_trace(TEST_TRACES)

    net_env = env.Environment(all_cooked_time=all_cooked_time,
                              all_cooked_bw=all_cooked_bw,all_cooked_rtt=all_cooked_rtt)
