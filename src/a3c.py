...
class ActorNetwork(object):
    ...
    def get_gradients(self, inputs, acts, act_grad_weights, entropy_weight=0.5):
...
def compute_gradients(s_batch, a_batch, r_batch, terminal, actor, critic, entropy_weight=0.5):
    """
